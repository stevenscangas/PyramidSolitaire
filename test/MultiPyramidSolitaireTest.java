...
public class MultiPyramidSolitaireTest {
  ...
  private BasicPyramidSolitaire defaultSolitaire = new MultiPyramidSolitaire();
  private BasicPyramidSolitaire notRandomSolitaire = new MultiPyramidSolitaire(randValue);
  ...
  public void testIsGameOverGameWon() {
    notRandomSolitaire.startGame(standardDeck, true, 2, 10);
    PyramidSolitaireTextualView notRandomSolitaireTextualView =
        new PyramidSolitaireTextualView(notRandomSolitaire);
    ...
    notRandomSolitaire.discardDraw(4);
    notRandomSolitaire.discardDraw(5);
  ...
  @Test
  public void testSwitchGameFromBasic() {
