 ...
 * rules of gameplay.
 *
 * @param <Card> the type of cards this model uses
 */
public interface PyramidSolitaireModel<Card> {
   ...
   */
  void startGame(List<Card> deck, boolean shuffle, int numRows, int numDraw)
